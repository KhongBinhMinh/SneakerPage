...
const SlideProducts2 = (props: Props) => {
    ...
    return (
        ...
        <div className="justify-between items-center w-max lg:w-full h-full w-full object-cover object-center">
            ...
            <div className="bg-white" >
                <div className="mx-auto max-w-2xl py-9 mb-5 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-900 py-3 my-5">ÇOK SATANLAR</h2>
                    <Slider {...settings}>
